...
import '.././index.css';
import { Input, Descriptions, Avatar, message, Button } from 'antd';
...
function Cookbook() {
    ...
    return (
        <div>
            {/* back */}
            <div className='fn-clear'><Button href='./#/cookbook' className='rightbtn' type='primary' >back</Button></div>
            <p className="btnline">
                {/* collect */}
            ...
            <Descriptions title="detail" bordered size="small">
                ...
                <Descriptions.Item label="strMeal">{detail.meals[0].strMeal}</Descriptions.Item>
