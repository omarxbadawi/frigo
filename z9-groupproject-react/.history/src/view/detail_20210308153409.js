        ...
        column={{ xxl:4, xl:3, lg:3, md:3, sm:2, xs:1}} span= "2">
            ...
            <div>
                <Descriptions title="Ingredients" bordered size="small" span = "2">
                    <Descriptions.Item label={detail.meals[0].strIngredient1 == null ? '' : detail.meals[0].strIngredient1}>{detail.meals[0].strIngredient1 == null ? '' : detail.meals[0].strIngredient1}</Descriptions.Item>
                    <Descriptions.Item label="Ingredient2">{detail.meals[0].strIngredient2 == null ? '' : detail.meals[0].strIngredient2}</Descriptions.Item>
                    <Descriptions.Item label="Ingredient3">{detail.meals[0].strIngredient3 == null ? '' : detail.meals[0].strIngredient3}</Descriptions.Item>
                    <Descriptions.Item label="Ingredient4">{detail.meals[0].strIngredient4 == null ? '' : detail.meals[0].strIngredient4}</Descriptions.Item>
                </Descriptions>
