    ...
    return (
      <div className="site-layout-background" style={{ padding: 10, minHeight: 300 }}>
        ...
        <Carousel autoplay>
              ...
              <img src={Img1} style={{height:"300px", width:"450px"}}></img>
                <p> food1</p>
              </div>
              <div>
              <img src={Img2} style={{height:"300px", width:"450px"}}></img>
                <p> food2</p>
              </div>
              <div>
              <img src={Img3} style={{height:"300px", width:"450px"}}></img>
                <p> food3</p>
              </div>
              <div>
              <img src={Img4} style={{height:"300px", width:"450px"}}></img>
               <p> food4</p>
              </div>
              </Carousel>
