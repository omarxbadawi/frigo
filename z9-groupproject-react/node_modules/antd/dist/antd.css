...
.ant-click-animating-node {
  ...
  -webkit-box-shadow: 0 0 0 0 #3f6600;
          box-shadow: 0 0 0 0 #3f6600;
...
@-webkit-keyframes waveEffect {
  100% {
    -webkit-box-shadow: 0 0 0 #3f6600;
            box-shadow: 0 0 0 #3f6600;
...
.ant-select-tree .ant-select-tree-treenode.drop-container > [draggable] {
  -webkit-box-shadow: 0 0 0 2px #3f6600;
          box-shadow: 0 0 0 2px #3f6600;
}
...
.ant-upload-list-picture .ant-upload-list-item-error .ant-upload-list-item-thumbnail .anticon svg path[fill='#f4ffb8'],
.ant-upload-list-picture-card .ant-upload-list-item-error .ant-upload-list-item-thumbnail .anticon svg path[fill='#f4ffb8'] {
  fill: #fff2f0;
}
.ant-upload-list-picture .ant-upload-list-item-error .ant-upload-list-item-thumbnail .anticon svg path[fill='#3f6600'],
.ant-upload-list-picture-card .ant-upload-list-item-error .ant-upload-list-item-thumbnail .anticon svg path[fill='#3f6600'] {
  fill: #3f6600;
}
